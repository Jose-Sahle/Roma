// srvROMA.cpp : Implementation of WinMain


// Note: Proxy/Stub Information
//      To build a separate proxy/stub DLL, 
//      run nmake -f srvROMAps.mk in the project directory.
...
inline void CServiceModule::ServiceMain(DWORD /* dwArgc */, LPTSTR* /* lpszArgv */)
{
    ...
    LogEvent(_T("Serviço parado"), EVENTLOG_INFORMATION_TYPE, _T("Roma"));
}
    ...
    HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nShowCmd*/)
{
    ...
    _Module.Init(ObjectMap, hInstance, IDS_SERVICENAME, &LIBID_SRVROMALib);
